...
var Template = function (args) { return ((0, jsx_runtime_1.jsx)(MyLabel_1.MyLabel, __assign({}, args))); }; // Se construye nuestro componente, devolviendo una instancia nueva
exports.Basic = Template.bind({}); // Se crea una copia de "Template" y la vuelve una historia
exports.Basic.args = {
